...
| **Block Inline Scripts / WebSockets**     | Blocks inline JavaScript and WebSocket connections – Prevents execution of scripts embedded directly in the webpage’s HTML (inline scripts) and blocks persistent real-time connections (WebSockets) often used for tracking, ads, or live updates. | ✅                                           | ❌                                               | ❌                                          |
